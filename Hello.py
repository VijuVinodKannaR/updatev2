...
def google_chrome():
    try:
        ...
        subprocess.run(["start", "C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe", "-Command", "winget upgrade chrome --disable-interactivity"],  shell=True, check=True)
